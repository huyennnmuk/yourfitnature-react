// sliderData.ts
// Centralized data for VerticalSlider
  ...
  // Slide 1
{
  ...
  features: [
    ...
    'Evidence-backed strain & ingredient validation',
    'Ongoing formula optimization as your needs change',
  ],
},
// Slide 2
{
  ...
  features: [
    ...
    'Allergen & additive auditing',
    'Custom comparison dashboards',
  ],
},
// Slide 3
{
  ...
  features: [
    ...
    'Monthly microbiome insights',
    '24/7 chat for product or wellness questions',
  ],
},
