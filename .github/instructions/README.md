# 🚀 AI Dev Tasks for [VS Code] 🤖

Welcome to **AI Dev Tasks**! This repository provides a collection of `.mdc` (Markdown Command) files designed to supercharge your feature development workflow within the [VS Code](https://code.visualstudio.com/) editor. By leveraging these commands with the VS Code AI Agent, you can systematically approach building features, from ideation to implementation, with built-in checkpoints for verification.
...
You can create a lightweight PRD directly within VS Code:

1.  Ensure you have the `create-prd.mdc` file from this repository accessible.
2.  In the VS Code AI chat, initiate PRD creation:
    ...
    ```
    *(Tip: For complex PRDs, use the most comprehensive AI mode available in VS Code for best results.)*
...
2.  In the VS Code AI chat, use the PRD to create tasks:
...
2.  In the VS Code AI chat, tell the AI to start with the first task (e.g., `1.1`):
...
While it's not always perfect, this method has proven to be a very reliable way to build out larger features with AI assistance in VS Code.
...
1.  **Clone or Download:** Get these `.mdc` files into your project or a central location where VS Code can access them.
2.  **Follow the Workflow:** Systematically use the `.mdc` files in the VS Code AI chat as described in the 5-step workflow above.
3.  **Adapt and Iterate:**
...
*   **Comprehensive AI Mode for PRDs:** As mentioned, using the most advanced AI mode in VS Code for PRD creation (`create-prd.mdc`) can yield more thorough and higher-quality results if your budget supports it.
